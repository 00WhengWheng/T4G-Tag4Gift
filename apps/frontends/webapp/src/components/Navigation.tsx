  ...
  return (
    <>
      ...
      <header className="sticky top-0 z-50 w-full">
        <div className="glass-card border-b border-base-300/50">
          <div className="container mx-auto px-4">
            <div className="flex h-16 items-center justify-between">
              {/* Logo */}
              <div className="flex items-center">
                <Link to="/" className="flex items-center">
                  <span className="text-2xl font-bold text-gradient">Tag4Gift</span>
                </Link>
              </div>
              ...
              <div className="flex items-center space-x-2">
                ...
                <button
                  ...
                  className="md:hidden p-2 rounded-lg text-base-content/70 hover:text-base-content hover:bg-base-200"
                >
